...
export default class MaladieComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('maladie-heading'));
...
export class MaladieDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('santeplantesApp.maladie.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-maladie'));
}
