...
export default class TradipraticienComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('tradipraticien-heading'));
...
export class TradipraticienDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('santeplantesApp.tradipraticien.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-tradipraticien'));
}
