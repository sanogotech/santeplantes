...
export default class BienfaitComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('bienfait-heading'));
...
export class BienfaitDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('santeplantesApp.bienfait.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-bienfait'));
}
