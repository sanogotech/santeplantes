...
export default class PlanteComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('plante-heading'));
...
export class PlanteDeleteDialog {
  ...
  title: ElementFinder = element(by.id('santeplantesApp.plante.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-plante'));
}
