...
export default class TraitementComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('traitement-heading'));
...
export class TraitementDeleteDialog {
  ...
  title: ElementFinder = element(by.id('santeplantesApp.traitement.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-traitement'));
}
