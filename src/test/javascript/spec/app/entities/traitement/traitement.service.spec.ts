...
describe('Service Tests', () => {
  describe('Traitement Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Traitement', async () => {
      ...
      it('should not update a Traitement', async () => {
      ...
      it('should not return a list of Traitement', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Traitement', async () => {
