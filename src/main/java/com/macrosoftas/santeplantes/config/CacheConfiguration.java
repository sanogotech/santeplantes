package com.macrosoftas.santeplantes.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.macrosoftas.santeplantes.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.macrosoftas.santeplantes.repository.UserRepository.USERS_BY_EMAIL_CACHE);
